...
SECRET_KEY = 'django-insecure-d0deba%zt4w_toxp!yb4qzn*wii9zb-#6fjtwj2u9q-^b%_@g5'
...
MIDDLEWARE = [
    ...
    'jwt_project.middleware.APITrackingMiddleware',
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '5/minute',# 5 request per min for anon
        'user': '100/day',# 100 per day for user 
    },
}
